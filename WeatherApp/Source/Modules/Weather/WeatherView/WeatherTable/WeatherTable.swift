...
enum WeatherTableCellModel {
    ...
    var identifier: String {
        ...
        case .moreCell: return MoreInfoTableCell.identifier
        }
    }
}
...
final class WeatherTable: UITableView {
    ...
    init() {
        ...
        register(MoreInfoTableCell.self, forCellReuseIdentifier: MoreInfoTableCell.identifier)
    }
...
extension WeatherTable: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(
        ...
        case let .moreCell(model):
            let tempCell = cell as? MoreInfoTableCell
